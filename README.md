...
Lambda function that stores input Message into DynamoDB
- BaseMessageApp stores BaseMessage objetcs into 'Text' DynamoDB table
- MessageApp stores Message objetcs into 'Message' DynamoDB table
